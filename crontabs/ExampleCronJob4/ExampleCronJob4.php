<?php
	...
	# Set log file name
	define('CRON_LOG', CRON_TMP_DIR . 'example-cron-job4.log');
	# Set output file name
	define('CRON_OUTPUT_FILE', CRON_TMP_DIR . 'example-cron-job4.out');
	# Set status file name
	define('CRON_STATUS_FILE', CRON_TMP_DIR . 'example-cron-job4.status');
	# Set stop file name
	define('CRON_STOP_FILE', CRON_TMP_DIR . 'example-cron-job4.stop');
	# Set pid file name
	define('CRON_PID_FILENAME', 'example-cron-job4');
	# Set pid dir path
	...
	require_once( CRON_ROOT_DIR .  ".classes" . DS . 'example-cron-job4.class.php');

	// init
	cronRunner::init( new exampleCronJob4CronService() ) ;
